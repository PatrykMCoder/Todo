...
public class NoteRecyclerViewAdapter extends RecyclerView.Adapter<NoteRecyclerViewAdapter.NoteListViewHolder> {
    ...
    private final ArrayList<JSONHelperNote> arrayNotes;
    private final Context context;
    private final String userID;

    private MainActivity mainActivity;

    public NoteRecyclerViewAdapter(Context context, ArrayList<JSONHelperNote> arrayNotes, String userID) {
    ...
    public void onBindViewHolder(@NonNull NoteListViewHolder holder, int position) {
        ...
        holder.cardView.setOnClickListener(v -> {
                ...
                mainActivity.initFragment(new NotePreviewFragment(userID, arrayNotes.get(position)._id), true);
        });
    }
