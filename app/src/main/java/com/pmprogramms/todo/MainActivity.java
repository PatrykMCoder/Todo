...
public class MainActivity extends AppCompatActivity implements BottomNavigationView.OnNavigationItemSelectedListener, NavigationView.OnNavigationItemSelectedListener, View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (TitleSearchHandle.getTitle() != null) {
            ...
            bundle.putString("todoID", TitleSearchHandle.getId());
            bundle.putString("todoTitle", TitleSearchHandle.getTitle());
            bundle.putBoolean("todoArchive", TitleSearchHandle.isArchive());
            bundle.putInt("todoColor", Color.parseColor(TitleSearchHandle.getColor()));
