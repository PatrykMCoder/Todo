...
public class LoginDialog extends DialogFragment {
    ...
    public class EditUserProfileAsync extends AsyncTask<String, String, TaskState> {
        ...
        protected TaskState doInBackground(String... strings) {
            ...
            if (password != null) {
                code = APIClient.editUserProfile(userID, username, emailOld, emailNew, password);
            } else {
                code = APIClient.editUserProfile(userID, username, emailOld, emailNew, null);
            }
