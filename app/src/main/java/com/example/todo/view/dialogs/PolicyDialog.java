...
public class PolicyDialog extends DialogFragment {
    ...
    private String policyValue = "<h1 style='text-align: center;'><b>TodoNote Privacy Policy</b></h1>\n" +
            ...
            "        TodoNote collects the email addresses of those who submit information through voluntary activities such as registrations. The user data we collect is used to improve. I only collect personal data that is required to provide our services, and we only store it insofar that it is necessary to deliver these services.<br/>\n" +
            "        <p style='text-align: center;'><b>Your data</b></p>\n" +
            "        TodoNote uses third party vendors and hosting partners to provide the necessary hardware, software, networking, storage, and related technology required to run TodoNote. Although TodoNote owns the code, and all rights to the TodoNote application, you retain all rights to your data. I will never share your personal data with a 3rd party without your prior authorization, and I will never sell data to 3rd parties. We transfer data with third-parties necessary to our ability to provide our services, all of whom are GDPR-compliant and provide the necessary safeguards required if they are outside of the EU.\n" +
